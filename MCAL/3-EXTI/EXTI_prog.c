...
/*define global array of pointer to functions to hold the pointer passed from tha application */
static void (*EXTI_pfFuncPtr[3])(void)={NULL,NULL,NULL};

void EXTI_voidInit(void)
{
#if EXTI_u8INT0_TRIG_SRC==LOW_LEVEL
	/*configure INT0 as Low level edge*/
	CLR_BIT(MCUCR,MCUCR_ISC00);
	CLR_BIT(MCUCR,MCUCR_ISC01);
#elif EXTI_u8INT0_TRIG_SRC==ON_CHANGE
	/*configure INT0 as ON CHANGE*/
...
#error "Wrong EXTI_u8INT0_TRIG_SRC configuration option "
	...
	/*configure INT1 as Low level edge*/
	CLR_BIT(MCUCR,MCUCR_ISC10);
	CLR_BIT(MCUCR,MCUCR_ISC11);
#elif EXTI_u8INT1_TRIG==ON_CHANGE
	/*configure INT1 as ON CHANGE*/
